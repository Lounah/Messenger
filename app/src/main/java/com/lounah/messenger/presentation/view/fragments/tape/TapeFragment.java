package com.lounah.messenger.presentation.view.fragments.tape;
...
public class TapeFragment extends BaseFragment {
    ...
    protected void setToolbarTitle() {
        ((MessengerMainActivity)getActivity()).setToolbarTitle(getResources().getString(R.string.bottom_navigation_item_tape));
    }
